...
namespace NLPAndTheWhiteWhale
{
    public class SmartBookSearch
    {
        ...
        public SmartBookSearch()
        {
            ...
            SmartBooks.Add(new SmartBook("Sperm whale"));
            SmartBooks.Add(new SmartBook("Whaling ship"));
            SmartBooks.Add(new SmartBook("All the whales"));
            ...
            SmartBooks.Add(new SmartBook("The blue whale"));
            ...
            SmartBooks.Add(new SmartBook("Humpback Whale"));
